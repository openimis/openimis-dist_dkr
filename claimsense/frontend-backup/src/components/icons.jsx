...
export function WarnIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function SpinnerIcon({ className = "w-8 h-8" }) {
  return (
    <div
      className={`${className} border-2 border-teal-500 border-t-transparent rounded-full animate-spin`}
      role="status"
      aria-label="Loading"
    />
  );
